              ...
              child: RefreshIndicator(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>DetailsOrder(orderModel: cubit.ordersAdminList[index])));
                        },
                        child: Container(
                          height: 200.0,
...
class DetailsOrder extends StatelessWidget {
  ...
  const DetailsOrder({Key? key, required this.orderModel}) : super(key: key);
